...
if __name__ == "__main__":
    ...
    # Create a face cascade classifier using cv2.data.haarcascades
    ...
    def getImagesAndLabels(path):
        ...
        for imagePath in imagePaths:
            ...
            # Detect faces in the grayscale image using trained_face_data
            faces = trained_face_data.detectMultiScale(img_numpy)
