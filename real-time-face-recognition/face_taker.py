...
if __name__ == '__main__':
    ...
    # Load the pre-trained face cascade classifier using cv2.data.haarcascades
    ...
    while True:
        ...
        # Detect faces in the frame using trained_face_data
        ...
        # Take 30 face samples and stop video
        elif count >= 30:
            break
